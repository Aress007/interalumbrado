# 🌐 Sitio Web — Consorcio Interalumbrado de Cúcuta
...
- **JavaScript (ES6+)** — interactividad (carrusel, menú, comentarios dinámicos)  
- **Formspree** — gestión de envío de formularios  
- **GitHub** — control de versiones y alojamiento del código  
- **Netlify** — despliegue del sitio web en línea  
...
El sitio mantiene coherencia visual y facilidad de uso en todos los dispositivos.
...
Berta Johanna Salamanca Bayona
bsalamanca@sena.edu.co - johanna.salamancab@gmail.com
